...
public class TitleScreen extends World
{
    ...
    public TitleScreen(){
        ...
        addObject(new Button("Leaderboards", buttonHeight, 1350.0/300.0, "Login"), getWidth()/2, getHeight()*12/20);
        //addObject(new Button("Instructions", buttonHeight, 900.0/300.0, "Instructions"), getWidth()/2, getHeight()*14/20);
